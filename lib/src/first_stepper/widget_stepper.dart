...
class WidgetStepper extends StatelessWidget {
  /// Each image defines a step. Hence, total number of widgets determines the total number of steps.
  ...
  /// Specifies the alignment of the WidgetStepper
  final AlignmentGeometry alignment;

  /// Creates an WidgetStepper widget.
  WidgetStepper({
    this.widgets,
